...
// Display users and provide an option to delete
...
while ($user = mysqli_fetch_assoc($users)) {
    ...
    echo "<strong>User_id:</strong> {$user['user_id']}<br>";
    echo "<strong>Email:</strong> {$user['email']}<br>";
    echo "<strong>Full Name:</strong> {$user['full_name']}<br>";
    echo "<strong>Registration Date:</strong> {$user['registration_date']}<br>";
    echo "<a class='delete-user-link' href='delete_user.php?user_id={$user['user_id']}'>Delete User</a><br>";
    echo "</div><br>";
}
